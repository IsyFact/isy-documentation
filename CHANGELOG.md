...
- [2026-04-24] (glossary) `IFS-5286`: extend term "API-Gateway" to include several architectural views
- [2026-04-09] (documentation-guide) `IFS-5226`: describe how to use adaptive colors in draw.io diagrams 
