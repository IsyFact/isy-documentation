...
* `prerelease`: (optional) Kennzeichnung der Version als https://docs.antora.org/antora/latest/component-prerelease/[Entwicklungsstands].

Wie die Parameter zu setzen sind, werden in den Abschnitten "<<konfiguration-version>>" und "<<version-entwicklung>>".
