...
* release/(*): Entwicklungsbranches für Minor-Releases (beispielsweise release/3.x) werden über Git mit der Versionsnummer des derzeitigen Major-Releases versehen.
...
Bei schnellen Release-Zyklen können allein Releases über Tags in die Online-Dokumentation aufgenommen werden.
