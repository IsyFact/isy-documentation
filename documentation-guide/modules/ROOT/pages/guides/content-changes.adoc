...
Es gibt folgende Möglichkeiten, Deprecations auszuzeichnen:
...
Für eine Deprecation Markierung an einer kleinen Textstelle oder Tabellenzelle kann folgende Kurzform gewählt werden:
