...
|einstieg
|xref:isyfact-standards-doku:einstieg:einstieg.adoc[] in die IsyFact & Inhalte zur IsyFact allgemein

|icon:ban[title=Deprecation] [.line-through]#blaupausen#
|→ `referenzarchitektur`

|referenzarchitektur
|Inhalte der Säule xref:4.0.x@isyfact-standards-doku:referenzarchitektur:index.adoc[]

|bausteine
|Allgemeine Inhalte der Säule xref:isyfact-standards-doku:bausteine:bausteine.adoc[]

|isy-\{baustein}
|Inhalte des jeweiligen Bausteins

|plattform
|Inhalte der Säule xref:isyfact-standards-doku:plattform:plattform.adoc[]

|methodik
|Inhalte der Säule xref:isyfact-standards-doku:methodik:methodik.adoc[]

|werkzeuge
|Inhalte der Säule xref:isyfact-standards-doku:werkzeuge:werkzeuge.adoc[]

|icon:ban[title=Deprecation] [.line-through]#changelog#
|→ `release`

|release
|xref:4.0.x@isyfact-standards-doku:release:releasenotes.adoc[Änderungsdokumentation] zum aktuellen Release
|===
