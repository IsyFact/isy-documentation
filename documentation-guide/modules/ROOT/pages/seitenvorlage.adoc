...
[TIP]
====
Die Online-Dokumentation der IsyFact nutzt als Konvention zur Benennung von Ordnern und Seiten https://developer.mozilla.org/de/docs/Glossary/Kebab_case[Kebab Case], da Ordner- und Seitennamen Bestandteile der URL zum Aufruf der Seiten sind.
...
📂 software-technisch
  ...
  📄 backend.adoc
  📄 it-system.adoc
  📄 it-system-zerlegung.adoc <.>
📄 index.adoc
----
<.> Aufruf über `/software-technisch/backend/anwendungskern.html`
<.> Aufruf über `/software-technisch/it-system-zerlegung.html`
====
