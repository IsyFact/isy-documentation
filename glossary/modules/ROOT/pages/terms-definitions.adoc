...
CAUTION: Auf Ebene der <<glossar-anwendungslandschaft>>, Systemlandschaft und <<glossar-plattform>> wird die Gesamtheit aller Service-Gateways als "das" Service-Gateway bezeichnet.
Hierbei handelt es sich um einen reinen Sammelbegriff.
