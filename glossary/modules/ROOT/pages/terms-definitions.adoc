...
// tag::api-gateway-definition[]

Das API-Gateway hat zur Aufgabe, Aufrufe aus der xref:glossary::terms-definitions.adoc#glossar-systemlandschaft[Systemlandschaft] an xref:glossary::terms-definitions.adoc#externes-system[externe Systeme] sowie Aufrufe von externen Systemen in die Systemlandschaft weiterzuleiten.
