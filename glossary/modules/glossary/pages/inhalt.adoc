...
[[glossar-blaupause]]
Blaupause [.changed]#<<glossar-referenzarchitektur,abgelöst>># [.release]#xref:3.0.x@isyfact-standards-doku:einstieg:einstieg.adoc[≤ IsyFact 3]#::
...
Querschnittskomponente (QK) [.superseded]#<<glossar-querschnittsanwendung,abgelöst>># [.release]#≤ IsyFact 2#::
...
Referenzarchitektur [.proposed]#vorgeschlagen# [.release]#xref:4.0.x@isyfact-standards-doku:einstieg:einstieg.adoc[≥ IsyFact 4]#::
