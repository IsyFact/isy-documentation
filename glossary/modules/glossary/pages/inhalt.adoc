...
[[glossar-blaupause]]
Blaupause [.glossary-changed]#<<glossar-referenzarchitektur,abgelöst>># [.glossary-release]#xref:3.0.x@isyfact-standards-doku:einstieg:einstieg.adoc[≤ IsyFact 3]#::
Blaupausen beschreiben die durch die IsyFact vorgegebene Architektur und Konzepte einer Anwendungslandschaft für den Betrieb von Geschäftsanwendungen von den drei Architektursichten aus der fachlichen Sicht, der softwaretechnischen Sicht und der Sicht der technischen Infrastruktur.
 ...
 Abgelöst → <<glossar-referenzarchitektur,Referenzarchitektur>>
...
[[glossar-plis]]
PLIS [.glossary-deprecated]#veraltet#::
...
Ehemalige Bezeichnung: <<glossar-querschnittskomponente,Querschnittskomponente>>
...
[[glossar-querschnittskomponente]]
Querschnittskomponente (QK) [.glossary-changed]#<<glossar-querschnittsanwendung,abgelöst>># [.glossary-release]#≤ IsyFact 2#::

Abgelöst → <<glossar-querschnittsanwendung,Querschnittsanwendung>> 

=== R

[[glossar-referenzarchitektur]]
Referenzarchitektur [.glossary-proposed]#vorgeschlagen# [.glossary-release]#xref:4.0.x@isyfact-standards-doku:einstieg:einstieg.adoc[≥ IsyFact 4]#::
