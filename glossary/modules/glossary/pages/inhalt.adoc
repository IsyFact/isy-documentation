...
Die software-technische Umsetzung einer Anwendung besteht aus mehreren xref:glossary:glossary:master.adoc#glossar-it-system[IT-Systemen].
...
Sie setzt hierfür Fachlogik um.
