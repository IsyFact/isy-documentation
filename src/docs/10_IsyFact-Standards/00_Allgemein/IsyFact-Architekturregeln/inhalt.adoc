...
include::../../../10_IsyFact-Standards/10_Blaupausen/Grundlagen_interne_Servicekommunikation/architekturregeln.adoc[tags=architekturregeln]
...
include::../../../20_IsyFact-Erweiterungen/20_Bausteine/Konzept_Session_Management/architekturregeln.adoc[tags=architekturregeln]
include::../../../20_IsyFact-Erweiterungen/20_Bausteine/Nutzungsvorgaben_isy-session/architekturregeln.adoc[tags=architekturregeln]
