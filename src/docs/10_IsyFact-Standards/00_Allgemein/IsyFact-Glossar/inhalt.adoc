...
|Im Sinne der Architektur der <<isyfact>> werden externe Dienste über <<service-gateway,Service-Gateways>> als externer Service im <<awk>> aufrufbar.
...
image::AufbauServLogik.png[align="center"]
