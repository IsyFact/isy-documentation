...
In komplexen Anwendungslandschaften werden Anwendungssysteme in der Regel in funktionale Kategorien eingeordnet und typisiert (bspw. Register und Geschäftsanwendungen). 
