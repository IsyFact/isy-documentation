...
In komplexen Anwendungslandschaften werden <<glossar-Anwendungssystem>>e in der Regel in funktionale Kategorien eingeordnet und typisiert (bspw. Register und Geschäftsanwendungen). 
