...
:desc-table-namqa:  Name einer Querschnittsanwendung
...
:desc-table-fachGK:  Name einer ausgelagerten fachlichen Geschäftskomponente
...
:desc-table-techGK:  Name einer ausgelagerten technsichen Geschäftskomponente
...
* `isy-geschaeftsanwendung`
* `isy-geschaeftsanwendung-batch`
