...
Damit stellt der Anwendungskern innerhalb des Systems allgemein nutzbare <<glossar-Dienst>>e zur Verfügung.
...
Dabei können alle Dienste des <<glossar-Anwendungskern>>s genutzt werden.
