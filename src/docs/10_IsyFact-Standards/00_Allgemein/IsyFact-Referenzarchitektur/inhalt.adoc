...
* Einer zentrale Startseite, welche den eingeloggten Benutzern die Fachanwendungen der Register-Plattform, für welche sie berechtigt sind, präsentiert.
...
Es werden sechs Systemumgebungen unterschieden:
