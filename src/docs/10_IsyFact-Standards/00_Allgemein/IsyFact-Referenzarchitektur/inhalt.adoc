...
Hierbei ist zu unterscheiden, ob ausschließlich IT-Systeme innerhalb Systemlandschaft miteinander kommunizieren oder ob die Kommunikation auch IT-Systeme einschließt, die außerhalb liegen (siehe <<image-overkommIF>>).
