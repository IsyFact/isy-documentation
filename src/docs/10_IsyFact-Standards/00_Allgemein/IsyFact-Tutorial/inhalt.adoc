...
Weitere Details können <<IsyFact-Referenzarchitektur>> entnommen werden.
...
Für fachliche Komponenten wird eine Basisimplementierung in <<IsyFact-Referenzarchitektur>> beschrieben.
