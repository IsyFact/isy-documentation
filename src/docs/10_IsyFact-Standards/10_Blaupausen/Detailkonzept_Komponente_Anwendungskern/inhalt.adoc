...
Ist dies der Fall, sollte an dieser Stelle über ein `Code-Refactoring` nachgedacht werden.

Ein weiterer Vorteil von _Constructor Injection_ ist, dass die injizierten Abhängigkeiten während der Laufzeit nicht veränderbar sind.
