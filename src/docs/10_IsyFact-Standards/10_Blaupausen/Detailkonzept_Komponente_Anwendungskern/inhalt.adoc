...
Die Konfiguration der Anwendung wird (wie im Detailkonzept Überwachung und Konfiguration <<KonzeptUeberwachungKonfiguration>> beschrieben) über die Datei `application.properties` durchgeführt.
