...
In der folgenden Grafik wird das Muster der _Dependency Injection_ exemplarisch visualisiert.
...
[[vorgabe-dependency-injection]]
==== Vorgabe zur Dependency Injection
