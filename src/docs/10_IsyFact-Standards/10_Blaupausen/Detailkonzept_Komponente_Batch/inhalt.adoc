...
Jeder Batch erhält beim Logging eine eigene Korrelations-ID.

[INFO]
Die Korrelations-ID für Batches war in älteren Versionen des Batchrahmens die ID des Batches statt einer UUID.
