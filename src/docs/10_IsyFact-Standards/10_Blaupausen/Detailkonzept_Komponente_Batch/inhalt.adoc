...
Dieser Kontext ist ein Kind-Kontext des eigentlichen <<glossar-Anwendungskontext>>es und kann alle Beans des Anwendungskontextes verwenden.
...
Zusätzlich erhält jeder zu verarbeitende Satz die Satznummer als Korrelations-ID, welche an die Korrelations-ID des Batches angehängt wird.
