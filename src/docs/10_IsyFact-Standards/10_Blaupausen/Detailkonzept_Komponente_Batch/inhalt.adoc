...
* Sobald der letzte Datensatz verarbeitet wurde, wird die Status-Tabelle aktualisiert, auf der Ausführungsbean eine Shutdown-Methode aufgerufen und die (letzte) Transaktion beendet.
...
WARNING: Die Korrelations-ID für Batches war in älteren Versionen des Batchrahmens die ID des Batches statt einer UUID.
