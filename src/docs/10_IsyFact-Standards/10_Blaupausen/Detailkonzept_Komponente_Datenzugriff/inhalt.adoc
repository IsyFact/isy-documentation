...
Die Konfiguration des Pools beschränkt sich auf die Konfiguration der Klasse `oracle.ucp.jdbc.PoolDataSource` in der DataSource-Bean.
...
In der Konfigurationsdatei `jpa.xml` werden die Spring-Beans `EntityManager`
