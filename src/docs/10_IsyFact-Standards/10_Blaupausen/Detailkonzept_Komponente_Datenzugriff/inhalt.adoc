...
1. Ableitung des Queries über den Namen der Methode

2. Ableitung über eine manuell definierte Query.


bevorzugt wird  Variante 1
Für eine Referenz zu den Möglichkeiten siehe X
...
Die Konfiguration von Queries erfolgt über über Annotationen an den Entitätsklassen.
