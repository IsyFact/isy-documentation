...
Damit eingehende Anfragen richtig verarbeitet werden können, müssen diese zunächst kodiert werden. Um eine korrektes
Kodieren zu gewährleisten, muss der `SetCharacterEncodingFilter` als erster Filter-Mapping Eintrag in der `web.xml`
eingetragen sein.
