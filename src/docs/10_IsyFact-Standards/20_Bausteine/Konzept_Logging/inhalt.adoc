...
NOTE: Die Klasse MdcHelper stellt die Funktion entferneKorrelationIds() für das Löschen aller Korrelations-Ids in MDC (Mapped Diagnostic Context) bereits (siehe <<NutzungsvorgabenLogging>>).
