...
Im Folgenden werden die Aufgaben und grobe Funktionsweise der Komponenten für die Autorisierung von Anfragen in einer <<glossar-Geschaeftsanwendung>> erläutert.
