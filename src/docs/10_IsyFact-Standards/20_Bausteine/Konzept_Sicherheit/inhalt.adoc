...
Anwender gelangen in der Regel entweder über das Portal oder den Service Gateway in eine Anwendungslandschaft.
...
Für Services des Querschnitts, die nahezu alle Aufrufe benötigen und die keine sicherheitskritischen Operationen anbieten, kann eine zentrale Rolle (z.B. `Querschnitt_Nutzer`) angelegt werden.
...
IT-Systeme werden intern in Form von Batches oder Timer-Tasks aktiv.
