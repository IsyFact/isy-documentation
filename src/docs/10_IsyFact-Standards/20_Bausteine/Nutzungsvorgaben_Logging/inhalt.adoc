...
Dies wird bereits durch die Erweiterung der HttpInvoker-Implementierung (IsyHttpInvokerProxyFactoryBean) des Bausteins Service umgesetzt (siehe <<DetailkonzeptKomponenteService>>), sodass hierfür keine Anpassung notwendig ist.
