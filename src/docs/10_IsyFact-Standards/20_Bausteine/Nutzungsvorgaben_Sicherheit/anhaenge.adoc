...
Die IsyFact kommt standardmäßig mit Unterstützung für CAMS als IAM-System.
...
Der CAMS-Server stellt am Webserver vor Weiterleitung der Anfrage an eine Fachanwendung sicher, dass diese erfolgreich authentifiziert wurden.
...
----
<beans>
    <bean id="authenticationProvider" class="de.bund.bva.pliscommon.sicherheit.cams.web.CamsAuthenticationProvider"/>

    <bean id="processingFilter" class="de.bund.bva.pliscommon.sicherheit.cams.web.CamsAuthenticationProcessingFilter">
