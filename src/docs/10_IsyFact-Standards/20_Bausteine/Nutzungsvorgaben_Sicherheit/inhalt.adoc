...
<beans>
    ...
    <bean id="gesichertInterceptor"
        class="de.bund.bva.pliscommon.sicherheit.annotation.GesichertInterceptor">
        <property name="sicherheit" ref="sicherheit"/>
...
Diese Methode kann in den Watchdog des IT-Systems (siehe <<KonzeptUeberwachungKonfiguration>>) eingebunden werden.
