...
Danach sollte das Ressource Window etwa wie folgt aussehen:

:desc-image-resbrowser: Ressource Browser mit hinzugefügten UML Profiles
...
Seit EA Version 7 kann man die Schriftart eines Elements für ein einzelnes Diagramm setzen, indem man den Pinsel neben dem markierten Element anklickt und das Schriftart-Feld nutzt (siehe <<guiselectfnt>>).
