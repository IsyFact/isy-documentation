...
_In der Regel wird für jedes IT-System (Fachanwendung) jeweils ein eigenes Dokument Systementwurf angelegt.
...
_Für ein neues Verfahren sind eine Fachanwendung und ein Service-Gateway zu erstellen.
Das Service-Gateway stellt die Services der Fachanwendung bereit.
Weiterhin wird ein Native-Client benötigt, welcher ebenfalls die Fachanwendung aufruft.
Für diesen Fall werden Fachanwendung, Native-Client und Service-Gateway als Teilsysteme in einem gemeinsamen Systementwurf beschrieben._
...
:desc-image-packetstruktur-enterprise-architect-modells: Packetstruktur des Enterprise Architect Modells
...
image::packetstruktur-enterprise-architect-modells.png[align = center, title-align=center]
...
image::einbettung-anwendungssystem.png[align = center, title-align=center]
...
====
_In diesem Kapitel wird ein Systemüberblick gegeben und die Aspekte des Gesamtsystems beschrieben, die für alle oder mehrere Teilsysteme gelten. Das können Verfahren, Festlegungen oder die Beschreibung gemeinsam genutzter Komponenten sein. In der Regel hat ein System mehrere Teilsysteme, z. B. eine Fachanwendung und ein Service Gateway._
...
Teilsysteme sind z. B.: ein Service-Gateway oder eine Fachanwendung.
...
image::teilsysteme.png[align = center, title-align=center]
...
* _Blau für Fachanwendungen (R/G/B: 153 / 204 / 255)_
...
_Durch die Verwendung der IsyFact-Referenzarchitektur erfüllt die Anwendung XYZ die Anforderungen, die allgemein an Fachanwendungen gestellt werden: Sie läuft auf separaten Hardware-Systemen, die Failover und Lastverteilung ermöglichen.
...
image::deployment-diagramm.png[align = center, title-align=center]
...
_Die Teilsysteme haben (soweit es sich um Fachanwendungen handelt) folgende, fest vorgegebene T-Architektur:_
====
...
image::darstellung-teilsysteme.png[align = center, title-align=center, width=75%]
...
image::ueberblick-teilsysteme.png[align = center, title-align=center]
...
image::uml-komponentendiagramm.png[align = center, title-align=center]
...
image::komponenten-zusammenhaenge.png[align = center, title-align=center]
...
image::logisches-datenmodell.png[align = center, title-align=center]
