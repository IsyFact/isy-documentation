...
// tag::release-2.2.0[]
Die bereits etablierten Vorgaben zur Quellcodeablage wurden dem Dokument hinzugefügt und Neuerung wie die Ablage von Dokumenten im AsciiDoc-Format ergänzt.
