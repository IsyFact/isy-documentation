...
In Batch-Modulen gibt es im Wurzel-Verzeichnis (project-root) nur `src/main/resources/` als einzelnes Unterverzeichnis.
...
In Deployment-Modulen gibt es im Wurzel-Verzeichnis (project-root) nur `src/main/resources/` als einzelnes Unterverzeichnis.
