...
:desc-table-maven-grIDMod: Group-ID von Modulen/Artefakten
[id="table-maven-grIDMod",reftext="{table-caption} {counter:tables}"]
.{desc-table-maven-grIDMod}
...
:desc-table-maven-artIDMod: Artefakt-ID von maven-Modulen/-Artefakten
[id="table-table-maven-artIDMod",reftext="{table-caption} {counter:tables}"]
.{desc-table-maven-artIDMod}
[cols="1,4",options="header"]
|====
2+|{desc-table-maven-artIDMod}
...
:desc-listing-Projektstruktur-Batch: Struktur eines Batch-Projekts
...
:desc-listing-Projektstruktur-Deployment: Struktur eines Deployment-Projekts
...
:desc-table-ssimpl:  Namen der Interface-Implementierungen bei hauptsächlicher Impl. des Interfaces
