...
:desc-listing-komponentenchangelog_ueberschrift: Komponentenchangelog Inhalt
[id="listing-komponentenchangelog_ueberschrift",reftext="{listing-caption} {counter:listings }"]
.{desc-listing-komponentenchangelog_ueberschrift}
[source,adoc]
----
= Changelog
----
...
Somit ergibt sich folgender Gesamtaufbau des Komponentenchangelog:

:desc-listing-komponentenchangelog_gesamt: Gesamtstruktur Komponentenchangelog
[id="listing-komponentenchangelog_gesamt",reftext="{listing-caption} {counter:listings }"]
.{desc-listing-komponentenchangelog_gesamt}
[source,adoc]
----
= Changelog
...
:desc-listing-projektchangelog_einbindung_releases: Gesamtstruktur Projektchangelog
