...
Einen Querverweis auf eine Kapitelüberschrift setzt man über zwei spitze Klammerpaare.
...
[source,asciidoc]
----
Zum <<beispiel-kapitel, Beispiel-Kapitel>> gelangen Sie über einen Mausklick.
----
...
Der erzeugte Text sollte wie folgt aussehen:

_Zum <<kapitelueberschriften, Beispiel-Kapitel>> gelangen Sie über einen Mausklick._
_Im Übrigen handelt es sich bei dem Beispiel-Kapitel um das Kapitel <<kapitelueberschriften>>._
...
IMPORTANT: Beachten Sie, dass die Abbildungen nicht im Verzeichnis des Dokuments abgelegt werden, sondern im Unterordner `/images`.
...
IMPORTANT: Beachten Sie, dass die vorgegebene Syntax zwingend eingehalten werden muss, weil die Abbildungen ansonsten vom  Skript nicht erkannt werden.
