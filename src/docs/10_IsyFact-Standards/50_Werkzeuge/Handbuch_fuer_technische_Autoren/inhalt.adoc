...
Dieser Abschnitt beschreibt, welche Attribute und Inhalte in den den Vorlagedateien (vgl. <<die-mustervorlage-vorbereiten>>) angepasst werden können.
...
:desc-table-master-attributes: Attribute der master.adoc
[id="table-master-attributes",reftext="{table-caption} {counter:tables}"]
.{desc-table-master-attributes}
...
:desc-listing-pom-asciidoc: Integration des Asciidoc-Maven-Plugins
[id="listing-pom-asciidoc",reftext="{listing-caption} {counter:listings }"]
.{desc-listing-pom-asciidoc}
[source,xml,subs="attributes+"]
----
 <plugin>
...
:desc-image-architektur_changelogs: Zusammenführung der einzelnen Komponentenchangelogs
