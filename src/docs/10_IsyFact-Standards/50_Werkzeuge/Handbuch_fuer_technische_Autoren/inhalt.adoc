...
[id="image-hallowelt",reftext="{figure-caption} {counter:figures}"]
...
[id="listing-glossar",reftext="{listing-caption} {counter:listings }"]
.{desc-listing-glossar}
[source,asciidoc]
----
[id="glossar-halloweltbeispiel",reftext="Hallo Welt Beispiel"]
