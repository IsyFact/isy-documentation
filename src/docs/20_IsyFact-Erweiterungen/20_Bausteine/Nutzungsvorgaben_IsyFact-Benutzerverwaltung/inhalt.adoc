...
// todo Ist das so richtig? Die Rollen werden schon in der Datenbank gespeichert, aber die Zuordnung von Rollen
// todo zu Rechten geschiet über die rollenrechte.xml.
// todo Welches Attribut RolleName?
