...
Querschnittssystem::
Querschnittssysteme sind spezielle Anwendungen in einer Querschnittsdomäne, welche Basisdienste für weitere (mindestens zwei) Geschäftsanwendungen einer Anwendungslandschaft bereitstellen.
